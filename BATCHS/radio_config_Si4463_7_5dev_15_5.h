...
// MOD_type: 3    Rsymb(sps): 4800    Fdev(Hz): 7500    RXBW(Hz): 15200    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433.92    API_TC: 29    fhst: 50000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 3 (BW =  15.44 kHz);  NB-filter 3 (BW = 15.44 kHz)
// 
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x07, 0x08, 0x0C, 0x0C, 0x27, 0x0B, 0x00
...
*/
#define RF_MODEM_TX_RAMP_DELAY_8 0x11, 0x20, 0x08, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0x70, 0x10
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x00, 0x82, 0x03, 0xEE, 0xA2, 0x01, 0xF8, 0x02, 0xC2
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0xC0, 0x0E, 0x06, 0x42, 0xC0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x1C, 0x1C, 0x00, 0x1A, 0xC8, 0x00, 0x00, 0x29
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x01, 0xCC, 0x01, 0x80, 0xFF
