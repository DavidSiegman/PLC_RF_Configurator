...
// MOD_type: 3    Rsymb(sps): 4800    Fdev(Hz): 2500    RXBW(Hz): 5200    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433.92    API_TC: 29    fhst: 50000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 6 (BW =   5.58 kHz);  NB-filter 6 (BW = 5.58 kHz)
// 
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x00, 0x41, 0x07, 0xDD, 0x44, 0x07, 0x90, 0x02, 0x00
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x00, 0x12, 0xC0, 0x2A, 0x01, 0x05, 0xE0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x0E, 0x0E, 0x00, 0x1A, 0x42, 0xAB, 0x00, 0x28
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x03, 0xD6, 0x03, 0x01, 0x33, 0x01, 0x80, 0xFF
