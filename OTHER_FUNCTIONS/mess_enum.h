...
enum
{
    ...
    SEND_READ_INTERFACES_CONTROL_NEW,
    SEND_WRITE_INTERFACES_CONTROL_NEW,
    SEND_READ_MASK_DESTINATION_NEW,
    SEND_WRITE_MASK_DESTINATION_NEW,
    SEND_READ_UPLINK_MODE_NEW,
    SEND_WRITE_UPLINK_MODE_NEW,
    SEND_READ_BROADCASTING_MODE_NEW,
    SEND_WRITE_BROADCASTING_MODE_NEW
};
