...
enum
{
    ...
    GLOBAL_WUT_CAL,                   // 9
    INT_CTL_ENABLE,                   // 10
    INT_CTL_PH_ENABLE,                // 11
    INT_CTL_MODEM_ENABLE,             // 12
    INT_CTL_CHIP_ENABLE,              // 13
    FRR_CTL_A_MODE,                   // 14
    FRR_CTL_B_MODE,                   // 15
    FRR_CTL_C_MODE,                   // 16
    FRR_CTL_D_MODE,                   // 17
    PREAMBLE_TX_LENGTH,               // 18
    PREAMBLE_CONFIG_STD_1,            // 19
    PREAMBLE_CONFIG_NSTD,             // 20
    PREAMBLE_CONFIG_STD_2,            // 21
    PREAMBLE_CONFIG,                  // 22
    PREAMBLE_PATTERN_3,               // 23
    PREAMBLE_PATTERN_2,               // 24
    PREAMBLE_PATTERN_1,               // 25
    PREAMBLE_PATTERN_0,               // 26
    PREAMBLE_POSTAMBLE_CONFIG  ,      // 27
    PREAMBLE_POSTAMBLE_PATTERN_3,     // 28
    PREAMBLE_POSTAMBLE_PATTERN_2,     // 29
    PREAMBLE_POSTAMBLE_PATTERN_1,     // 30
    PREAMBLE_POSTAMBLE_PATTERN_0,     // 31
    SYNC_CONFIG,                      // 32
    SYNC_BITS_BIT_3,                  // 33
    SYNC_BITS_BIT_2,                  // 34
    SYNC_BITS_BIT_1,                  // 35
    ...
    SI4463_NONE_1,                    // 44
    PKT_LEN,                          // 45
    PKT_LEN_FIELD_SOURCE,             // 46
    PKT_LEN_ADJUST,                   // 47
    PKT_TX_THRESHOLD,                 // 48
    PKT_RX_THRESHOLD,                 // 49
    PKT_FIELD_1_LENGTH_1,             // 50
    PKT_FIELD_1_LENGTH_0,             // 51
    PKT_FIELD_1_CONFIG,               // 52
    PKT_FIELD_1_CRC_CONFIG,           // 53
    PKT_FIELD_2_LENGTH_1,             // 54
    PKT_FIELD_2_LENGTH_0,             // 55
    PKT_FIELD_2_CONFIG,               // 56
    PKT_FIELD_2_CRC_CONFIG,           // 57
    PKT_FIELD_3_LENGTH_1,             // 58
    PKT_FIELD_3_LENGTH_0,             // 59
    PKT_FIELD_3_CONFIG,               // 60
    PKT_FIELD_3_CRC_CONFIG,           // 61
    PKT_FIELD_4_LENGTH_1,             // 62
    PKT_FIELD_4_LENGTH_0,             // 63
    PKT_FIELD_4_CONFIG,               // 64
    PKT_FIELD_4_CRC_CONFIG,           // 65
    PKT_FIELD_5_LENGTH_1,             // 66
    PKT_FIELD_5_LENGTH_0,             // 67
    PKT_FIELD_5_CONFIG,               // 68
    PKT_FIELD_5_CRC_CONFIG,           // 69
    PKT_RX_FIELD_1_LENGTH_1,          // 70
    PKT_RX_FIELD_1_LENGTH_0,          // 71
    PKT_RX_FIELD_1_CONFIG,            // 72
    PKT_RX_FIELD_1_CRC_CONFIG,        // 73
    PKT_RX_FIELD_2_LENGTH_1,          // 74
    PKT_RX_FIELD_2_LENGTH_0,          // 75
    PKT_RX_FIELD_2_CONFIG,            // 76
    PKT_RX_FIELD_2_CRC_CONFIG,        // 77
    PKT_RX_FIELD_3_LENGTH_1,          // 78
    PKT_RX_FIELD_3_LENGTH_0,          // 79
    PKT_RX_FIELD_3_CONFIG,            // 80
    PKT_RX_FIELD_3_CRC_CONFIG,        // 81
    PKT_RX_FIELD_4_LENGTH_1,          // 82
    PKT_RX_FIELD_4_LENGTH_0,          // 83
    PKT_RX_FIELD_4_CONFIG,            // 84
    PKT_RX_FIELD_4_CRC_CONFIG,        // 85
    PKT_RX_FIELD_5_LENGTH_1,          // 86
    PKT_RX_FIELD_5_LENGTH_0,          // 87
    PKT_RX_FIELD_5_CONFIG,            // 88
    PKT_RX_FIELD_5_CRC_CONFIG,        // 89
    MODEM_MOD_TYPE,                   // 90
    MODEM_MAP_CONTROL,                // 91
    MODEM_DSM_CTRL,                   // 92
    MODEM_DATA_RATE_2,                // 93
    MODEM_DATA_RATE_1,                // 94
    MODEM_DATA_RATE_0,                // 95
    MODEM_TX_NCO_MODE_3,              // 96
    MODEM_TX_NCO_MODE_2,              // 97
    MODEM_TX_NCO_MODE_1,              // 98
    MODEM_TX_NCO_MODE_0,              // 99
    MODEM_FREQ_DEV_2,                 // 100
    MODEM_FREQ_DEV_1,                 // 101
    MODEM_FREQ_DEV_0,                 // 102
    MODEM_FREQ_OFFSET_1,              // 103
    MODEM_FREQ_OFFSET_0,              // 104
    MODEM_TX_FILTER_COEFF_8,          // 105
    MODEM_TX_FILTER_COEFF_7,          // 106
    MODEM_TX_FILTER_COEFF_6,          // 107
    MODEM_TX_FILTER_COEFF_5,          // 108
    MODEM_TX_FILTER_COEFF_4,          // 109
    MODEM_TX_FILTER_COEFF_3,          // 110
    MODEM_TX_FILTER_COEFF_2,          // 111
    MODEM_TX_FILTER_COEFF_1,          // 112
    MODEM_TX_FILTER_COEFF_0,          // 113
    MODEM_TX_RAMP_DELAY,              // 114
    MODEM_MDM_CTRL,                   // 115
    MODEM_IF_CONTROL,                 // 116
    MODEM_IF_FREQ_2,                  // 117
    MODEM_IF_FREQ_1,                  // 118
    MODEM_IF_FREQ_0,                  // 119
    MODEM_DECIMATION_CFG1,            // 120
    MODEM_DECIMATION_CFG0,            // 121
    SI4463_NONE_2,                    // 122
    SI4463_NONE_3,                    // 123
    MODEM_BCR_OSR_1,                  // 124
    MODEM_BCR_OSR_0,                  // 125
    MODEM_BCR_NCO_OFFSET_2,           // 126
    MODEM_BCR_NCO_OFFSET_1,           // 127
    MODEM_BCR_NCO_OFFSET_0,           // 128
    MODEM_BCR_GAIN_1,                 // 129
    MODEM_BCR_GAIN_0,                 // 130
    MODEM_BCR_GEAR,                   // 131
    MODEM_BCR_MISC1,                  // 132
    MODEM_BCR_MISC0,                  // 133
    MODEM_AFC_GEAR,                   // 134
    MODEM_AFC_WAIT,                   // 135
    MODEM_AFC_GAIN_1,                 // 136
    MODEM_AFC_GAIN_0,                 // 137
    MODEM_AFC_LIMITER_1,              // 138
    MODEM_AFC_LIMITER_0,              // 139
    MODEM_AFC_MISC,                   // 140
    MODEM_AFC_ZIFOFF,                 // 141
    MODEM_ADC_CTRL,                   // 142
    MODEM_AGC_CONTROL,                // 143
    SI4463_NONE_4,                    // 144
    SI4463_NONE_5,                    // 145
    MODEM_AGC_WINDOW_SIZE,            // 146
    MODEM_AGC_RFPD_DECAY,             // 147
    MODEM_AGC_IFPD_DECAY,             // 148
    MODEM_FSK4_GAIN1,                 // 149
    MODEM_FSK4_GAIN0,                 // 150
    MODEM_FSK4_TH_1,                  // 151
    MODEM_FSK4_TH_0,                  // 152
    MODEM_FSK4_MAP,                   // 153
    MODEM_OOK_PDTC,                   // 154
    ...
    MODEM_OOK_CNT1,                   // 156
    MODEM_OOK_MISC,                   // 157
    MODEM_RAW_SEARCH,                 // 158
    MODEM_RAW_CONTROL,                // 159
    MODEM_RAW_EYE_1,                  // 160
    MODEM_RAW_EYE_0,                  // 161
    MODEM_ANT_DIV_MODE,               // 162
    MODEM_ANT_DIV_CONTROL,            // 163
    MODEM_RSSI_THRESH,                // 164
    MODEM_RSSI_JUMP_THRESH,           // 165
    MODEM_RSSI_CONTROL,               // 166
    MODEM_RSSI_CONTROL2,              // 167
    MODEM_RSSI_COMP,                  // 168
    SI4463_NONE_6,                    // 169
    SI4463_NONE_7,                    // 170
    MODEM_CLKGEN_BAND,                // 171
    RX1_CHFLT_COE_13,                 // 172
    RX1_CHFLT_COE_12,                 // 173
    RX1_CHFLT_COE_11,                 // 174
    RX1_CHFLT_COE_10,                 // 175
    RX1_CHFLT_COE_09,                 // 176
    RX1_CHFLT_COE_08,                 // 177
    RX1_CHFLT_COE_07,                 // 178
    RX1_CHFLT_COE_06,                 // 179
    RX1_CHFLT_COE_05,                 // 180
    RX1_CHFLT_COE_04,                 // 181
    RX1_CHFLT_COE_03,                 // 182
    RX1_CHFLT_COE_02,                 // 183
    RX1_CHFLT_COE_01,                 // 184
    RX1_CHFLT_COE_00,                 // 185
    RX1_CHFLT_COEM0,                  // 186
    RX1_CHFLT_COEM1,                  // 187
    RX1_CHFLT_COEM2,                  // 188
    RX1_CHFLT_COEM3,                  // 189
    RX2_CHFLT_COE_13,                 // 190
    RX2_CHFLT_COE_12,                 // 191
    RX2_CHFLT_COE_11,                 // 192
    RX2_CHFLT_COE_10,                 // 193
    RX2_CHFLT_COE_09,                 // 194
    RX2_CHFLT_COE_08,                 // 195
    RX2_CHFLT_COE_07,                 // 196
    RX2_CHFLT_COE_06,                 // 197
    RX2_CHFLT_COE_05,                 // 198
    RX2_CHFLT_COE_04,                 // 199
    RX2_CHFLT_COE_03,                 // 200
    RX2_CHFLT_COE_02,                 // 201
    RX2_CHFLT_COE_01,                 // 202
    RX2_CHFLT_COE_00,                 // 203
    RX2_CHFLT_COEM0,                  // 204
    RX2_CHFLT_COEM1,                  // 205
    RX2_CHFLT_COEM2,                  // 206
    RX2_CHFLT_COEM3,                  // 207
    ...
    PA_TC,                            // 211
    PA_RAMP_EX,                       // 212
    PA_RAMP_DOWN_DELAY,               // 213
    SYNTH_PFDCP_CPFF,                 // 214
    SYNTH_PFDCP_CPINT,                // 215
    SYNTH_VCO_KV,                     // 216
    SYNTH_LPFILT3,                    // 217
    SYNTH_LPFILT2,                    // 218
    SYNTH_LPFILT1,                    // 219
    ...
    MATCH_MASK_4,                     // 232
    MATCH_CTRL_4,                     // 233
    FREQ_CONTROL_INTE,                // 234
    FREQ_CONTROL_FRAC_2,              // 235
    FREQ_CONTROL_FRAC_1,              // 236
    FREQ_CONTROL_FRAC_0,              // 237
    FREQ_CONTROL_CHANNEL_STEP_SIZE_1, // 238
    FREQ_CONTROL_CHANNEL_STEP_SIZE_0, // 239
    FREQ_CONTROL_W_SIZE,              // 240
    FREQ_CONTROL_VCOCNT_RX_ADJ,       // 241
    RX_HOP_CONTROL,                   // 242
    RX_HOP_TABLE_SIZE,                // 243
    RX_HOP_TABLE_ENTRY                // 244-307
};
