...
typedef union{
    struct{
        ...
        unsigned  EEPROM_INIT_OK:             1; // не хранитс€ во FLASH
        unsigned  PLC_INIT_OK:                1; // не хранитс€ во FLASH
        unsigned  RF_INIT_OK:                 1; // не хранитс€ во FLASH
        unsigned  RS_INIT_OK:                 1; // не хранитс€ во FLASH
    }Field;
    unsigned int Word;
...
typedef union Debug_Control_Type_Def{
    struct{
        ...
        // биты включени€ отладочных сообщений RS
